...
import MALE_NOCOLOR_ICON from '@/static/imgs/match-reservation/match-reservation-female-nocolor-icon.svg'
import FEMALE_COLOR_ICON from '@/static/imgs/match-reservation/match-reservation-female-color-icon.svg'
import FEMALE_NOCOLOR_ICON from '@/static/imgs/match-reservation/match-reservation-female-color-icon.svg'
